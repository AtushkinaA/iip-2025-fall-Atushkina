...
public class Amphibians extends Animal implements HowIEating, Temperature, WhatWeWantEat, Printing {
    public Amphibians(String title, String environment, String whatBloods, String bodyStructure, String haveSpine, String typeEating) {
        super(title, environment, whatBloods, bodyStructure, haveSpine, typeEating);
    }

    @Override
    void say() {
        System.out.println("Наша особенность - способность комфортно чувствовать себя сразу в двух средах — в воде и на суше.");
    }
