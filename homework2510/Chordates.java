...
public class Chordates extends Animal implements HowIEating, Temperature, WhatWeWantEat, Printing {
    public Chordates(String title, String environment, String whatBloods, String bodyStructure, String haveSpine, String typeEating) {
        super(title, environment, whatBloods, bodyStructure, haveSpine, typeEating);
    }

    @Override
    void say() {
        System.out.println("Наша особенность - наличие хорды.");
    }
